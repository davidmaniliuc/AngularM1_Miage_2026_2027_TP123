...
- Utiliser les middlewares Hono (`createMiddleware`) pour séparer validation, authentification et traitement métier.
...
- Pour un upload, contrôler `Content-Length`, le type MIME et la taille avant d'écrire, et générer un nom de stockage aléatoire.
