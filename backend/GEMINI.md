...
Respecte l’architecture Hono/Mongoose existante, les validations et les
...
des erreurs explicites et des logs sans secret. Pour les fichiers reçus via
`c.req.parseBody()`, vérifie la taille (`Content-Length` puis la taille réelle),
le type MIME et le nom de stockage avant toute écriture.
